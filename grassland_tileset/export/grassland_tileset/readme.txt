...
Hello! Thank you for downloading the Grasslands Tileset. Here are a few pointers to help you navigate and make sense of this zip file.

- In the root folder, you will find a folder named PNG. This folder contains all the objects and tiles as descriptively-named PNGs.

- In the root folder, you will also find a folder named spritesheet. This folder contains the spritesheet, and two choices of metadata format for reading the spritesheet. (Pick the format you like!)
